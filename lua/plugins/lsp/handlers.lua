...
local function select_client(method, bufnr)
	-- Workaround for nvim-tree diagnostics
...
function M.set_autocmds(client, bufnr)
	...
	if select_client("textDocument/formatting", bufnr) then
	...
	if select_client("textDocument/documentHighlight", bufnr) then
